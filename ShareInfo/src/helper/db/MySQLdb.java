...
public class MySQLdb {
	...
	public void setMessageInfo(String message, String username) {
		String query = "INSERT INTO shareinfo.messages(message, username) VALUES ('" + message + "', '" + username + "');";
		System.out.println("     DB query: " + query);
    	try {
	    	Statement st = this.conn.createStatement();
	    	st.executeUpdate(query);  	
	...
	public ArrayList<MessageInfo> getAllMessages() {
		String query = "SELECT * FROM shareinfo.messages ORDER BY id_message DESC;";
		System.out.println("     DB query: " + query);
