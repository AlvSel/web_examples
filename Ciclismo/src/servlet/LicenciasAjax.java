...
public class LicenciasAjax extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		ArrayList<MessageInfo> licenciasList = MySQLdb.getAllLicenciasUsuario(sesion.getAttribute("username").toString());
